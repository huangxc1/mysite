...
export default {
  ...
  mounted() {
    this.$refs.projectContainer.addEventListener("scroll", this.handlerScroll);
    this.$bus.$on("setMainScroll",this.handerSetMainScroll);
  },
  beforeDestroy() {
    this.$bus.$emit("mainScroll");
    this.$bus.$off("setMainScroll", this.handerSetMainScroll);
    this.$refs.projectContainer.removeEventListener(
      "scroll",
      this.handlerScroll
    );
  },
